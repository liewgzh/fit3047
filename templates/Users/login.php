    ...
    <div class="row">
        <div class="column column-50 column-offset-25">
            <div class="users form content">
                ...
                <?= $this->Html->link('Forgot password?', ['controller' => 'Users', 'action' => 'forgetPassword'], ['class' => 'button button-outline']) ?>
                <?= $this->Form->end() ?>

                <hr class="hr-between-buttons">

                <?= $this->Html->link('Register new user', ['controller' => 'Users', 'action' => 'useradd'], ['class' => 'button button-clear']) ?>
                <hr class="hr-between-buttons">
                <?= $this->Html->link('Go to Homepage', '/', ['class' => 'button button-clear custom-class']) ?>
            </div>
        </div>
    </div>
</div>
